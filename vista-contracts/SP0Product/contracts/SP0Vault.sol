...
import {SP0Product} from "./SP0Product.sol";
import {SP0VaultMetadata, VaultStatus} from "./Structs.sol";

contract SP0Vault is ERC20, Ownable {
    using SafeERC20 for ERC20;

    address public asset;
    SP0Product public sp0Product;

    /**
     * @notice Creates a new SP0Vault that is owned by the SP0Product
    ...
    function totalAssets() public view returns (uint256) {
        (, , , , , uint256 underlyingAmount, , , , , , , , , , ) = sp0Product
            .vaults(address(this));
